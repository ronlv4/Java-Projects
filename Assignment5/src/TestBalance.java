...
public class TestBalance {
    ...
    public static void main(String[] args) {
        ...
        t3.insert(new BankAccount("a", 9, 0));
        t3.insert(new BankAccount("a", 10, 0));
        t3.insert(new BankAccount("a", 11, 0));
        t3.insert(new BankAccount("a", 12, 0));
        t3.insert(new BankAccount("a", 13, 0));
        t3.insert(new BankAccount("a", 14, 0));
        t3.insert(new BankAccount("a", 15, 0));
        t3.insert(new BankAccount("a", 16, 0));
